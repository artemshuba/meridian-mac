...
class HttpService {
    ...
    func getRequest(url: String, parameters: [String : String], headers: [String : String]? = nil) -> HttpRequest {
        request(method: .get,
                url: url,
    ...
    func postJsonRequest(url: String, data: [String : String]) -> HttpRequest {
    ...
    func postDataRequest(url: String, data: Data, headers: [String : String]? = nil) -> HttpRequest {
        request(method: .post,
                url: url,
                parameters: [:],
                headers: headers,
